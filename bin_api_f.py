...
class Binance():
    ...
    methods = {
            ...
            'futuresAggTrades': {'url': 'fapi/v1/aggTrades', 'method': 'GET', 'private': False, 'futures': True},
            ...
            'futuresopenOrder':        {'url': 'fapi/v1/openOrders', 'method': 'GET', 'private': True, 'futures': True},
